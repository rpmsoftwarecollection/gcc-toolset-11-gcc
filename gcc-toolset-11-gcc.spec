...
# rm -rf gcc-dir.tmp
Source0: https://github.com/rpmsoftwarecollection/gcc-toolset-11-gcc/releases/download/download/gcc-%{version}-%{DATE}.tar.xz
...
BuildRequires: gcc-toolset-11-runtime, gcc-toolset-11-build
%if 0%{?rhel} == 7
...
%changelog
* Fri Oct 20 2023 Eduard Abdullin <eabdullin@almalinux.org> 11.2.1-9.2.alma.1
- Apply libstdc-Check-conversion-from-filesystem-path-to-wide.patch
- Apply libstdc-Mark-non-exported-function-always_inline.patch
